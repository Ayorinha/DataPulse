...
## Ecosystem position
 Data engineering benchmark toolkit

## Current mission
Data engineering layer: provides reproducible benchmarks for data processing workloads, quality and pipeline performance.
